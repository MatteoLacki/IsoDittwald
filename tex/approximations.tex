...
\begin{result}\label{Equatransneutronic Masses result}
	...
	{\small
		...
		\end{gathered}		
		\end{equation}}
	where $\Delta M$ stands for mass difference between a given isotope and the lighest isotope for that element, and \textsc{Mono} stands for the monoisotopic mass.   
\end{result}
\begin{proof}
